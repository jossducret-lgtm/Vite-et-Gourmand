...
final class EmployeeDishController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_employee_dish_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_employee_dish_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    {
        return $this->render('employee_dish/show.html.twig', [
            'dish' => $dish,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_employee_dish_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_employee_dish_delete', methods: ['POST'])]
