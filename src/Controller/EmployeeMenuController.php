...
final class EmployeeMenuController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_employee_menu_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_employee_menu_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    {
        return $this->render('employee_menu/show.html.twig', [
            'menu' => $menu,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_employee_menu_edit', methods: ['GET', 'POST'])]
